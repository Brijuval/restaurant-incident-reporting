...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-#nceju&#3e4(db1zj3k5!02-xk*#6223kj0*@+*+$@v_&)8)r1')
...
# Use PostgreSQL if DATABASE_URL environment variable is defined
if os.environ.get('DATABASE_URL'):
    DATABASES['default'] = dj_database_url.config(
        conn_max_age=600,
        ssl_require=False  # Render postgres doesn't strictly enforce SSL internally
    )
